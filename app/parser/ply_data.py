from app.parser.parser_classes import *
...
dices = {
    "d": DiceOperation,
    "b": ExplodingDiceOperation,
    "ad": AdvantageDiceOperation,
    "dd": DisadvantageDiceOperation,
    "ed": ElfAdvantageDiceOperation,
    "kd": QuadAdvantageDiceOperation,
}
